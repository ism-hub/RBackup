...
```
This will create a folder  *backupsFolder*/*backupsName*.dd-mm-yy_hh-mm-ss.incomplete and start backing-up the *source* from *remote*, after the backup completed it removes the *.incomplete* from the folder
